package com.example.kitsu.data.local.preferences

import android.content.Context
import android.content.SharedPreferences
import com.example.kitsu.data.local.preferences.PreferencesKeys.ACCESS_TOKEN_KEY
import com.example.kitsu.data.local.preferences.PreferencesKeys.IS_AUTHENTICATED
import com.example.kitsu.data.local.preferences.PreferencesKeys.LOGIN_KEY
import com.example.kitsu.data.local.preferences.PreferencesKeys.PASSWORD_KEY
import com.example.kitsu.data.local.preferences.PreferencesKeys.REFRESH_TOKEN_KEY
